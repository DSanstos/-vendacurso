...
<body>
  ...
  <div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">Formas de Pagamento - Condições Promocionais <span class="fa fa-smile-o"></span></h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="feature col">
        ...
        <p class="pb-2"><b>R$ 1.000</b> em 12x de <span class="text text-danger">R$ 83,33</span></p>
        <p><form method='post' action='https://cieloecommerce.cielo.com.br/transactionalvnext/order/buynow' target='blank'><input type='hidden' name='id' value='ba71532f-e44f-40df-b8b7-ba43b1e80306' /><input type='image' name='submit' alt='Comprar' src='https://cieloecommerce.cielo.com.br/backoffice/Content/img/buttons/button-5-1.png' /></form></p>
      </div>
      <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
        ...
        <p>Pagamento à vista R$ 700</p>
        <img src="qr-700.jpeg" height="250">
